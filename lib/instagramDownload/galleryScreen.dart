...
Directory dir = Directory('/storage/emulated/0/justload/Instagram');
Directory thumbDir = Directory('/storage/emulated/0/.justload/.thumbs');
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (_isImage[index] == false) {
                String thumb = fileList[index]
                    .toString()
                    .replaceAll('File: \'/storage/emulated/0/justload/Instagram/', '');
